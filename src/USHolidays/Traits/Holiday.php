...
trait Holiday
{
    ...
    private function holidays(int $year = null)
    {
        ...
        $holidays = [
            [
                'name' => AprilFoolsDay::$name,
                'search_names' => AprilFoolsDay::$searchNames,
                'date' => function () use ($year) {
                    return AprilFoolsDay::setAprilFoolsDay($year);
                },
                'bank_holiday' => AprilFoolsDay::$bankHoliday,
                'federal_holiday' => AprilFoolsDay::$federalHoliday,
                'start_year' => AprilFoolsDay::$startYear,
                'end_year' => AprilFoolsDay::$endYear,
                'bank_holiday_start_year' => AprilFoolsDay::$bankHolidayStartYear,
                'bank_holiday_end_year' => AprilFoolsDay::$bankHolidayEndYear,
                'federal_holiday_start_year' => AprilFoolsDay::$federalHolidayStartYear,
                'federal_holiday_end_year' => AprilFoolsDay::$federalHolidayEndYear,
            ],
        ];
